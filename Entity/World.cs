...
namespace TheChicagoProject.Entity
{
    ...
    public class World
    {
        ...
        public void tick(GameTime time) {
            ...
            int width = EntityManager.mainGame.GraphicsDevice.Viewport.Width / Tile.SIDE_LENGTH + 40;
            int height = EntityManager.mainGame.GraphicsDevice.Viewport.Height / Tile.SIDE_LENGTH + 40;
            if (playerMap == null)
